...
import com.altamirano.proyectofinal.databinding.ActivityDetailsRamItem1Binding
import com.altamirano.proyectofinal.databinding.ActivityDetailsRamItemBinding
...
class DetailsRamItem1 : AppCompatActivity() {

    private lateinit var binding: ActivityDetailsRamItem1Binding
    private var ramCharsItemsDB: MutableList<RamChars> = mutableListOf<RamChars>()

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        binding = ActivityDetailsRamItem1Binding.inflate(layoutInflater)
