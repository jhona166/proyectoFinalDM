...
import com.altamirano.proyectofinal.databinding.FragmentRickAndMorty1Binding
...
import com.altamirano.proyectofinal.logic.ramLogic.RamLogic1
import com.altamirano.proyectofinal.ui.activities.DetailsRamItem
import com.altamirano.proyectofinal.ui.activities.DetailsRamItem1
import com.altamirano.proyectofinal.ui.adapters.RickAndMortyAdapter
import com.altamirano.proyectofinal.ui.adapters.RickAndMortyAdapter1
...
class RickAndMortyFragment1 : Fragment() {
    private lateinit var binding: FragmentRickAndMorty1Binding

    private lateinit var lmanager: CarouselLayoutManager
    private var rvAdapter: RickAndMortyAdapter1 =
        RickAndMortyAdapter1({ sendRamItem(it) }, { saveRamItem(it) })
    ...
    override fun onCreateView(
        ...
        binding = FragmentRickAndMorty1Binding.inflate(layoutInflater, container, false)
    ...
    private fun sendRamItem(item: RamChars): Unit {
        val i = Intent(requireActivity(), DetailsRamItem1::class.java)
        ...
        return if (item == null || ramCharsItemsDB.contains(item)) {
            ...
            lifecycleScope.launch(Dispatchers.Main) {
                withContext(Dispatchers.IO) {
                    RamLogic1().insertRamCharstoDB(listOf(item))
                    ramCharsItemsDB = RamLogic1().getAllRamCharsDB().toMutableList()
                }
        ...
        if (Metodos().isOnline(requireActivity())) {
            ...
            lifecycleScope.launch(Dispatchers.Main) {
                ...
                ramCharsItems = withContext(Dispatchers.IO) {
                    ...
                    return@withContext (RamLogic1().getAllCharactersRam())
                } as MutableList<RamChars>
