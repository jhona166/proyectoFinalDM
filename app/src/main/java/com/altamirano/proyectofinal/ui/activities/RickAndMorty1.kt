...
import com.altamirano.proyectofinal.databinding.ActivityRickAndMorty1Binding
...
class RickAndMorty1 : AppCompatActivity() {

    private lateinit var binding: ActivityRickAndMorty1Binding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityRickAndMorty1Binding.inflate(layoutInflater)
